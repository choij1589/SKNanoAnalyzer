...
def process_histogram(hist_info):
    ...
    try:
        ...
        conv_data = conv.model_dump()['data']
...
def main():
    ...
    parser.add_argument('--input_folder', dest='input_folder',
                        ...
                        default=os.path.join(os.environ.get('SKNANO_OUTPUT', ''), 'MeasJetTagEff'))
    parser.add_argument('--input', dest='input',
                        help="Input ROOT file name", default='TTLL_powheg.root')
    parser.add_argument('--out_name_str', dest='out_name_str',
                        help="Output JSON file name prefix", default='')
    parser.add_argument('--era', dest='era',
                        help="Era to process (default: all eras)", default=None)
    ...
    if args.era:
        ...
        # If no specific era is provided, process all defined eras.
