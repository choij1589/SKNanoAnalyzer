#include "MeasFakeRateV3.h"

MeasFakeRateV3::MeasFakeRateV3() : leptonType(LeptonType::NONE) {}

MeasFakeRateV3::~MeasFakeRateV3() {}

void MeasFakeRateV3::initializeAnalyzer() {
    // Set flags
    ...
    if (MeasFakeMu8 || MeasFakeMu17) {
        ...
        throw std::runtime_error("[MeasFakeRateV3::initializeAnalyzer] No lepton type specified by flags");
    }
    ...
    if (MeasFakeMu8) {
        ...
        throw std::runtime_error("[MeasFakeRateV3::initializeAnalyzer] No trigger specified by userflags");
    }
...
void MeasFakeRateV3::executeEvent() {
    Event ev = GetEvent();
...
MeasFakeRateV3::RecoObjects MeasFakeRateV3::defineObjects(Event& ev, 
...
MeasFakeRateV3::Channel MeasFakeRateV3::selectEvent(Event& ev, const RecoObjects& recoObjects, const TString& ID, const TString& syst) {
...
MeasFakeRateV3::WeightInfo MeasFakeRateV3::getWeights(const Channel& channel,
                                                  const TString& ID,
                                                  const Event& event,
...
void MeasFakeRateV3::fillObjects(const Channel& channel,
                               const TString& ID,
                               const RecoObjects& recoObjects, 
...
TString MeasFakeRateV3::getBinPrefix(const double ptcorr, const double abseta) {
    int ptcorr_idx = -1;
    int abseta_idx = -1;
