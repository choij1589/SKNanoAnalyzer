...
MeasFakeRateV4::MeasFakeRateV4() : leptonType(LeptonType::NONE) {}
...
void MeasFakeRateV4::initializeAnalyzer() {
    ...
    if (MeasFakeMu8 || MeasFakeMu17) {
        ...
        throw std::runtime_error("[MeasFakeRateV4::initializeAnalyzer] No lepton type specified by flags");
    }
    ...
    if (MeasFakeMu8) {
        ...
        throw std::runtime_error("[MeasFakeRateV4::initializeAnalyzer] No trigger specified by userflags");
    }
